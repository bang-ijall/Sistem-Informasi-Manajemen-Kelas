...
function StatCard({ title, value, icon }) {
    return (
        <div className="flex items-center justify-between p-6 bg-white rounded-lg shadow-md dark:bg-gray-950 hover:scale-105 transition-transform duration-300">
            <div>
