                ...
                return (
                    <div key={field} className="relative flex flex-col">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 pr-10 text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-700"
                        />
                        {field === "password" && (
                            <button
                                type="button"
                                onClick={() => setShowPassword(!showPassword)}
                                className="absolute right-0 flex items-center pr-3 mt-8 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
                                tabIndex={-1}
                            >
...
export default function Page() {
    ...
    const handleLogin = async (form) => {
        ...
        try {
            ...
            if (!body.error) {
                document.cookie = `token=${body.data}; path=/; max-age=86400`
